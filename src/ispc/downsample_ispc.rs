...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of DownsamplingContext"][::std::mem::size_of::<DownsamplingContext>() - 32usize];
    ...
    ["Offset of field: DownsamplingContext::linear_row"]
        [::std::mem::offset_of!(DownsamplingContext, linear_row) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
